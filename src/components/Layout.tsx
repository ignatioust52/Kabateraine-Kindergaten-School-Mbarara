    ...
    <div className="min-h-screen" style={{ backgroundColor: '#f9efed' }}>
      ...
      >
        <div className="max-w-7xl mx-auto px-4 py-3 flex items-center justify-between">
          <button
            className="lg:hidden p-2 rounded-lg order-1"
          ...
          <Link to="/" className="flex items-center gap-3 order-2 lg:order-1 flex-row-reverse text-right lg:flex-row lg:text-left">
            <div
          ...
          <nav className="hidden lg:flex items-center gap-5 lg:order-2">
            {NAV_LINKS.map((link) => {
